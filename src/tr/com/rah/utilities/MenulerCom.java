...
import tr.com.rah.fe.SifreDuzenleFE;
...
import tr.com.rah.informfe.MusteriBilgisiFE;
import tr.com.rah.informfe.PersonelBilgisiFE;
import tr.com.rah.informfe.UrunBilgisiFE;
...
public class MenulerCom {
    ...
    public static JMenuBar initBar() {
        ...
        bar.add(dosyaMenu);
        JMenuItem urunlerItem = new JMenuItem("Ürün Bilgisi");
        dosyaMenu.add(urunlerItem);
        JMenuItem personellerItem = new JMenuItem("Personel Bilgisi");
        dosyaMenu.add(personellerItem);
        JMenuItem musterilerItem = new JMenuItem("Müşteri Bilgisi");
        dosyaMenu.add(musterilerItem);
        ...
        //şifre düzenle
        sifreDuzenleItem.addActionListener((ActionEvent e) -> {
            SwingUtilities.invokeLater(() -> {
                SifreDuzenleFE sifreDuzenleFE = new SifreDuzenleFE();
            });
        });
        ...
        //ürün bilgisi
        urunlerItem.addActionListener((ActionEvent e) -> {
            SwingUtilities.invokeLater(() -> {
                UrunBilgisiFE urunBilgisiFE = new UrunBilgisiFE();
            });
        });
        
        //Personel bilgisi
        personellerItem.addActionListener((ActionEvent e) -> {
            SwingUtilities.invokeLater(() -> {
                PersonelBilgisiFE personelBilgisiFE = new PersonelBilgisiFE();
            });
        });
        
        //müşteri bilgisi
        musterilerItem.addActionListener((ActionEvent e) -> {
            SwingUtilities.invokeLater(() -> {
                MusteriBilgisiFE musteriBilgisiFE = new MusteriBilgisiFE();
            });
        });
        return bar;
    }
